...
contract ImpliedVolatility is Ownable {
    ...
    mapping(uint32=>AggregatorV3Interface) internal ATMIv0;
    ...
    constructor () public{
        ATMIv0[1] = AggregatorV3Interface(0x696b6Fb2b093df94C428Efa68d6e7849702D9419);
        ATMIv0[2] = AggregatorV3Interface(0x99d837840c374A08C0bF0EE3bc16b84F1a29A640);
        paramA[1] = -4993746098;
        paramA[2] = -4993746098;
        paramB[1] = 50e8;
        paramB[2] = 50e8;
     ...
     */ 
    function SetAtmIv(uint32 underlying,address _Iv0)public onlyOwner{
        ATMIv0[underlying] = AggregatorV3Interface(_Iv0);
    }
    /**
    ...
    function calATMIv(uint32 underlying,uint256 expiration)internal view returns(uint256){
        ...
        (, int price,,,) = ATMIv0[underlying].latestRoundData();
        uint256 _iv0 = uint256(price)/100;
        if (index == 0){
            return _iv0;
        }
